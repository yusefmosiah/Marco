...
def run_macro_forecast_lab(config: MacroForecastConfig) -> dict[str, Any]:
    ...
    summary_plot_paths = {key: display_path(config.root, Path(value)) for key, value in plot_paths.items()}
    ...
    summary = {
        ...
        "fred_md_path": display_path(config.root, fred_md_path),
        "output_dir": display_path(config.root, output_dir),
